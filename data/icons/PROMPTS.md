# Bird Icon Generation Prompts

## Style Guide
Use this base prompt for consistent icons:
...
## File Naming
Save as: `[CODE].webp` or `[CODE].png` (e.g., `NOCA.png`)
...
| Code | Name | Prompt |
|------|------|--------|
| NOCA | Northern Cardinal | Stylized icon of a Northern Cardinal, simple flat design, circular frame, vibrant red male bird, white background, game asset style, clean vector look, centered composition, no text |
| CAWR | Carolina Wren | Stylized icon of a Carolina Wren, simple flat design, circular frame, warm brown bird with white eyebrow, white background, game asset style, clean vector look, centered composition, no text |
...
| Code | Name | Prompt |
|------|------|--------|
| BHNU | Brown-headed Nuthatch | Stylized icon of a Brown-headed Nuthatch, simple flat design, circular frame, small gray bird with brown cap, white background, game asset style, clean vector look, centered composition, no text |
| WBNU | White-breasted Nuthatch | Stylized icon of a White-breasted Nuthatch, simple flat design, circular frame, gray and white bird with black cap, white background, game asset style, clean vector look, centered composition, no text |
| BRCR | Brown Creeper | Stylized icon of a Brown Creeper, simple flat design, circular frame, streaky brown bird climbing tree, white background, game asset style, clean vector look, centered composition, no text |

### Woodpeckers
| Code | Name | Prompt |
|------|------|--------|
| DOWO | Downy Woodpecker | Stylized icon of a Downy Woodpecker, simple flat design, circular frame, small black and white woodpecker, white background, game asset style, clean vector look, centered composition, no text |
| HAWO | Hairy Woodpecker | Stylized icon of a Hairy Woodpecker, simple flat design, circular frame, black and white woodpecker, white background, game asset style, clean vector look, centered composition, no text |
| RBWO | Red-bellied Woodpecker | Stylized icon of a Red-bellied Woodpecker, simple flat design, circular frame, barred black and white with red cap, white background, game asset style, clean vector look, centered composition, no text |
| RHWO | Red-headed Woodpecker | Stylized icon of a Red-headed Woodpecker, simple flat design, circular frame, striking red head black and white body, white background, game asset style, clean vector look, centered composition, no text |
...
| Code | Name | Prompt |
|------|------|--------|
| WTSP | White-throated Sparrow | Stylized icon of a White-throated Sparrow, simple flat design, circular frame, brown streaked with white throat and yellow lores, white background, game asset style, clean vector look, centered composition, no text |
| SOSP | Song Sparrow | Stylized icon of a Song Sparrow, simple flat design, circular frame, brown streaked sparrow with central breast spot, white background, game asset style, clean vector look, centered composition, no text |
| CHSP | Chipping Sparrow | Stylized icon of a Chipping Sparrow, simple flat design, circular frame, rusty cap gray breast clean sparrow, white background, game asset style, clean vector look, centered composition, no text |
| SWSP | Swamp Sparrow | Stylized icon of a Swamp Sparrow, simple flat design, circular frame, rusty-winged sparrow with gray breast, white background, game asset style, clean vector look, centered composition, no text |
...
| Code | Name | Prompt |
|------|------|--------|
| BEKI | Belted Kingfisher | Stylized icon of a Belted Kingfisher, simple flat design, circular frame, blue-gray crested bird with large bill, white background, game asset style, clean vector look, centered composition, no text |
| RSHA | Red-shouldered Hawk | Stylized icon of a Red-shouldered Hawk, simple flat design, circular frame, brown hawk with rusty shoulders and barred tail, white background, game asset style, clean vector look, centered composition, no text |
| CACH | Carolina Chickadee | Stylized icon of a Carolina Chickadee, simple flat design, circular frame, small gray bird with black cap and bib, white background, game asset style, clean vector look, centered composition, no text |
| PIWA | Pine Warbler | Stylized icon of a Pine Warbler, simple flat design, circular frame, olive-yellow warbler, white background, game asset style, clean vector look, centered composition, no text |
| HETH | Hermit Thrush | Stylized icon of a Hermit Thrush, simple flat design, circular frame, brown thrush with spotted breast and rusty tail, white background, game asset style, clean vector look, centered composition, no text |
| BRTH | Brown Thrasher | Stylized icon of a Brown Thrasher, simple flat design, circular frame, rufous brown bird with long tail and streaked breast, white background, game asset style, clean vector look, centered composition, no text |
| GRCA | Gray Catbird | Stylized icon of a Gray Catbird, simple flat design, circular frame, slate gray bird with black cap, white background, game asset style, clean vector look, centered composition, no text |
...
BEKI: Stylized icon of a Belted Kingfisher, simple flat design, circular frame, blue-gray crested bird with large bill, white background, game asset style, clean vector look, centered composition, no text
BHNU: Stylized icon of a Brown-headed Nuthatch, simple flat design, circular frame, small gray bird with brown cap, white background, game asset style, clean vector look, centered composition, no text
BLJA: Stylized icon of a Blue Jay, simple flat design, circular frame, bright blue with white and black markings, white background, game asset style, clean vector look, centered composition, no text
BRCR: Stylized icon of a Brown Creeper, simple flat design, circular frame, streaky brown bird climbing tree, white background, game asset style, clean vector look, centered composition, no text
BRTH: Stylized icon of a Brown Thrasher, simple flat design, circular frame, rufous brown bird with long tail and streaked breast, white background, game asset style, clean vector look, centered composition, no text
...
GRCA: Stylized icon of a Gray Catbird, simple flat design, circular frame, slate gray bird with black cap, white background, game asset style, clean vector look, centered composition, no text
...
NOFL: Stylized icon of a Northern Flicker, simple flat design, circular frame, brown woodpecker with spotted breast and red nape, white background, game asset style, clean vector look, centered composition, no text
PIWA: Stylized icon of a Pine Warbler, simple flat design, circular frame, olive-yellow warbler, white background, game asset style, clean vector look, centered composition, no text
PIWO: Stylized icon of a Pileated Woodpecker, simple flat design, circular frame, large black woodpecker with red crest, white background, game asset style, clean vector look, centered composition, no text
RBWO: Stylized icon of a Red-bellied Woodpecker, simple flat design, circular frame, barred black and white with red cap, white background, game asset style, clean vector look, centered composition, no text
RHWO: Stylized icon of a Red-headed Woodpecker, simple flat design, circular frame, striking red head black and white body, white background, game asset style, clean vector look, centered composition, no text
RSHA: Stylized icon of a Red-shouldered Hawk, simple flat design, circular frame, brown hawk with rusty shoulders and barred tail, white background, game asset style, clean vector look, centered composition, no text
SASP: Stylized icon of a Savannah Sparrow, simple flat design, circular frame, streaky sparrow with yellow eyebrow, white background, game asset style, clean vector look, centered composition, no text
SOSP: Stylized icon of a Song Sparrow, simple flat design, circular frame, brown streaked sparrow with central breast spot, white background, game asset style, clean vector look, centered composition, no text
SWSP: Stylized icon of a Swamp Sparrow, simple flat design, circular frame, rusty-winged sparrow with gray breast, white background, game asset style, clean vector look, centered composition, no text
TUTI: Stylized icon of a Tufted Titmouse, simple flat design, circular frame, gray bird with crest, white background, game asset style, clean vector look, centered composition, no text
WBNU: Stylized icon of a White-breasted Nuthatch, simple flat design, circular frame, gray and white bird with black cap, white background, game asset style, clean vector look, centered composition, no text
...
| CERW | Cerulean Warbler | Stylized icon of a Cerulean Warbler, simple flat design, circular frame, sky-blue above with white breast and thin dark breast band, white background, game asset style, clean vector look, centered composition, no text |
...
| HOWA | Hooded Warbler | Stylized icon of a Hooded Warbler, simple flat design, circular frame, bright yellow face surrounded by black hood and throat, olive-green back, white background, game asset style, clean vector look, centered composition, no text |
